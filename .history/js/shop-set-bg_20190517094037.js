var vm = new Vue({
    ...
    methods: {
        changeBg() {
            alert(666);
            console.log(this.bgHistory.indexOf(this.currentPreview));
            if(this.bgHistory.indexOf(this.currentPreview) == -1) {
                this.bgHistory.push(this.currentPreview);
                localStorage.setItem('bgHistory',JSON.stringify(this.bgHistory));
            }
        },
        getBg(index) {
